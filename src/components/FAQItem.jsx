    ...
    return (
        <div className="faq_item">
            <div className="faq_grid" onClick={() => onToggleQuestion(categoryId, question.id)}>
                ...
                <div className="faq_content_quest">{question.question}
                ...
                <div className="feedback_content">
                    ...
                    <div className="feedback_buttons">
                        <button className="btn_yes" onClick={(e) => { e.stopPropagation(); onVote(categoryId, question.id, 1)}}>Да</button>
                        <button className="btn_no" onClick={(e) =>{ e.stopPropagation(); onVote(categoryId, question.id, -1)}}>Нет</button>
                    </div>
                        </>)}
                </div>
            </>)}
